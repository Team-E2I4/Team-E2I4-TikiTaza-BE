...
VALUES (NOW(), NOW(), '내 검과 심장은 데마시아의 것이다', 'SENTENCE'),
       ...
       (NOW(), NOW(), '모험은 역시 친구랑 같이해야 신 나는 법!', 'SENTENCE'),
       (NOW(), NOW(), '야생을 두려워하게 만들어주지', 'SENTENCE'),
       (NOW(), NOW(), '니코?! 역시 멋진 선택이야!', 'SENTENCE'),
       (NOW(), NOW(), '오직 나만이 승리로 이끌 수 있다', 'SENTENCE'),
       (NOW(), NOW(), '새로운 달이 떠오르고 있다', 'SENTENCE'),
       (NOW(), NOW(), '드레이븐의 리그에 오신 걸 환영한다!', 'SENTENCE'),
       (NOW(), NOW(), '대재앙에 한발 앞서 가는 거다!', 'SENTENCE'),
       (NOW(), NOW(), '한번 신 나게 춰볼까?', 'SENTENCE'),
       ...
       (NOW(), NOW(), '날개를 묶었다고 의지까지 꺾인 건 아니야', 'SENTENCE'),
       (NOW(), NOW(), '행운은 이를 싫어하는 법이지', 'SENTENCE'),
       (NOW(), NOW(), '죄지은 자 고통받을 지어다', 'SENTENCE'),
       (NOW(), NOW(), '일단 한 대 맞아 질문은 나중에 하고', 'SENTENCE'),
       (NOW(), NOW(), '어둠에 빠진 자들을 사냥해볼까', 'SENTENCE'),
       (NOW(), NOW(), '해체하여 지식을 습득한다', 'SENTENCE'),
       (NOW(), NOW(), '야생의 힘이다!', 'SENTENCE'),
       (NOW(), NOW(), '가장 듬직한 심장이 되어 드리지', 'SENTENCE'),
       ...
       (NOW(), NOW(), '검은 안개를 홀로 상대하지 마!', 'SENTENCE'),
       (NOW(), NOW(), '네가 가진 힘 믿을 건 오직 그뿐이야!', 'SENTENCE'),
       ...
       (NOW(), NOW(), '한잔하겠나?', 'SENTENCE'),
       (NOW(), NOW(), '어떤 고통을 선사해줄까?', 'SENTENCE'),
       ...
       (NOW(), NOW(), '화살 한 방으로 세상을 평정해주지', 'SENTENCE'),
       ...
       (NOW(), NOW(), '폭력은 모든 것을 해결해주지', 'SENTENCE'),
...
VALUES (NOW(), NOW(), '밥은 먹고 다니냐?', 'SENTENCE'),
       ...
       (NOW(), NOW(), '초원이 다리는 백만 불짜리 다리', 'SENTENCE'),
       (NOW(), NOW(), '거 죽기 딱 좋은 날씨네', 'SENTENCE'),
       (NOW(), NOW(), '용서는 미움에게 방 한 칸만 내주면 되는 거래', 'SENTENCE'),
       (NOW(), NOW(), '모히또 가서 몰디브 한 잔?', 'SENTENCE'),
       (NOW(), NOW(), '야, 우리가 돈이 없지 가오가 없냐?', 'SENTENCE'),
       (NOW(), NOW(), '호의가 계속되면 그게 권리인 줄 알아요.', 'SENTENCE'),
       (NOW(), NOW(), '지난일에 대해서 새로운 눈물을 낭비하지 말아라', 'SENTENCE'),
       (NOW(), NOW(), '살려는 드릴게', 'SENTENCE'),
       (NOW(), NOW(), '쫄리면 뒈지시던가', 'SENTENCE'),
       (NOW(), NOW(), '내일만 사는 놈은 오늘만 사는 놈한테 죽는다', 'SENTENCE'),
       (NOW(), NOW(), '싸늘하다. 가슴에 비수가 날아와 꽂힌다.', 'SENTENCE'),
       (NOW(), NOW(), '내일은 내일의 태양이 뜰 거야!', 'SENTENCE'),
       (NOW(), NOW(), '단지 두려움 때문에 좋아하는 일을 포기하지 마', 'SENTENCE'),
       (NOW(), NOW(), '날 쏘고 가라', 'SENTENCE'),
       (NOW(), NOW(), '당신의 눈동자에 건배를', 'SENTENCE'),
       (NOW(), NOW(), '너나 잘하세요', 'SENTENCE'),
       (NOW(), NOW(), '살아있네', 'SENTENCE'),
       (NOW(), NOW(), '누구냐 넌?', 'SENTENCE'),
       (NOW(), NOW(), '좋았어! 영 차!', 'SENTENCE'),
       (NOW(), NOW(), '인연을 붙잡아야 운명이 되는 거야', 'SENTENCE'),
       (NOW(), NOW(), '뭣이 중헌디?', 'SENTENCE'),
       (NOW(), NOW(), '드루와, 드루와', 'SENTENCE'),
       (NOW(), NOW(), '내가 니 시다바리가?', 'SENTENCE'),
       (NOW(), NOW(), '지금 내 기분이 그래. 어이가 없네?', 'SENTENCE'),
       (NOW(), NOW(), '이거 방탄유리야 개x끼야', 'SENTENCE'),
       (NOW(), NOW(), '가장 완벽한 계획이 뭔지 알아? 무계획이야.', 'SENTENCE'),
       (NOW(), NOW(), '늑대 새끼가 어떻게 개 밑으로 들어갑니까?', 'SENTENCE'),
       (NOW(), NOW(), '나 아트박스 사장인데', 'SENTENCE'),
       (NOW(), NOW(), '이거 마시면 우리 사귀는 거다', 'SENTENCE'),
       (NOW(), NOW(), '변화는 너로부터 시작해', 'SENTENCE'),
       (NOW(), NOW(), '나 이대 나온 여자야', 'SENTENCE'),
       (NOW(), NOW(), '너 피똥 싸고 기저귀 찬다', 'SENTENCE'),
       (NOW(), NOW(), '중구형 장난이 좀 심한 거 아니오', 'SENTENCE'),
       (NOW(), NOW(), '역사적으로 흘러가', 'SENTENCE'),
       (NOW(), NOW(), '동작 그만, 밑장빼기냐?', 'SENTENCE'),
       (NOW(), NOW(), '착한 사람은 왕이 되기 어려운 법이다', 'SENTENCE'),
       (NOW(), NOW(), '꿈에 사로잡혀 살다가 진짜 삶을 놓쳐선 안 돼', 'SENTENCE'),
       (NOW(), NOW(), '우리가 두려워할 것은 두려움뿐이죠', 'SENTENCE'),
       (NOW(), NOW(), '역경을 이겨내고 핀 꽃이 가장 아름다운 꽃이다', 'SENTENCE'),
       (NOW(), NOW(), '매너가 사람을 만든다', 'SENTENCE'),
       (NOW(), NOW(), '인생은 모두가 함께하는 여행이다', 'SENTENCE'),
       (NOW(), NOW(), '치열하게 살던가, 죽기만을 기다리던가', 'SENTENCE'),
       (NOW(), NOW(), '큰 힘에는 큰 책임이 따른다', 'SENTENCE'),
       (NOW(), NOW(), 'Cowards never start', 'SENTENCE'),
       (NOW(), NOW(), 'The winners never quit', 'SENTENCE'),
       (NOW(), NOW(), 'I can do this all day', 'SENTENCE'),
       (NOW(), NOW(), 'Dobby has no master, Dobby is a free elf!', 'SENTENCE'),
       (NOW(), NOW(), 'All is well', 'SENTENCE'),
       (NOW(), NOW(), '객체 생성에 유의미한 이름을 사용하라', 'SENTENCE'),
       (NOW(), NOW(), '오류 코드보단 예외를 사용하라', 'SENTENCE'),
       (NOW(), NOW(), '테스트 함수 하나당 한 개념만을 테스트하라', 'SENTENCE'),
       (NOW(), NOW(), '테스트는 빠르게 동작해야 한다', 'SENTENCE'),
       (NOW(), NOW(), '테스트는 어떤 환경에서도 반복 가능해야 한다', 'SENTENCE'),
       (NOW(), NOW(), '적절한 추상화 수준에서 이름을 선택하라', 'SENTENCE'),
       (NOW(), NOW(), '은 탄환은 없다', 'SENTENCE'),
       (NOW(), NOW(), '하드웨어: 사람이 발로 걷어찰 수 있는 부분', 'SENTENCE'),
       (NOW(), NOW(), '복잡성을 통제하는 것이 프로그래밍의 기초다', 'SENTENCE'),
       (NOW(), NOW(), '먼저 문제를 풀고 그다음에 개발하라', 'SENTENCE'),
       (NOW(), NOW(), '훌륭한 코드는 훌륭한 문서보다 낫다', 'SENTENCE'),
       (NOW(), NOW(), '발 없는 오픈소스 천 리 간다', 'SENTENCE'),
       (NOW(), NOW(), '한 줄 코드라도 서로 거들면 낫다', 'SENTENCE'),
       (NOW(), NOW(), '아니 쓴 코드에 오류 날까?', 'SENTENCE'),
       (NOW(), NOW(), '보기 좋은 코드가 디버깅하기 좋다', 'SENTENCE'),
       (NOW(), NOW(), '잘되면 프로그래머 탓, 못되면 시스템 탓', 'SENTENCE'),
       (NOW(), NOW(), '잘 키운 개발자 한 명 열 코더 안 부럽다', 'SENTENCE'),
       (NOW(), NOW(), '안에서 새는 메모리 밖에서도 샌다', 'SENTENCE'),
       (NOW(), NOW(), '디버깅 한 번으로 천 버그 잡는다', 'SENTENCE'),
       (NOW(), NOW(), '제 코드가 석 자', 'SENTENCE'),
       (NOW(), NOW(), '코딩 전 마음 다르고, 코딩 후 마음 다르다', 'SENTENCE'),
       (NOW(), NOW(), '개 같이 코딩해서 정승처럼 사표 쓴다', 'SENTENCE'),
       (NOW(), NOW(), '아는 코드도 다시 봐라', 'SENTENCE'),
       (NOW(), NOW(), '천줄 코드도 #include부터', 'SENTENCE'),
       (NOW(), NOW(), '먼저 커밋한 놈이 임자다', 'SENTENCE'),
       (NOW(), NOW(), '코딩도 식후경이다', 'SENTENCE'),
       (NOW(), NOW(), '비트 모아 테라', 'SENTENCE'),
       (NOW(), NOW(), '프로그래밍은 악기 연주와 같다', 'SENTENCE'),
       (NOW(), NOW(), '커피는 최고의 포션이다', 'SENTENCE'),
       (NOW(), NOW(), '개발은 0부터 시작한다. 그리고 1씩 쌓아간다.', 'SENTENCE'),
       (NOW(), NOW(), '오류 로그는 중요한 선물이다', 'SENTENCE'),
       (NOW(), NOW(), '의외로 컴퓨터는 거짓말하지 않는다', 'SENTENCE'),
       (NOW(), NOW(), '좋은 개발자와 나쁜 개발자는 종이 한 장 차이', 'SENTENCE'),
       (NOW(), NOW(), '개발에 마지막은 없다. 출시만이 있을 뿐이다.', 'SENTENCE'),
       (NOW(), NOW(), '오늘까지라는 말은 내일 아침까지라는 의미다', 'SENTENCE'),
       (NOW(), NOW(), '시스템 엔지니어는 지구력, 프로그래머는 순발력', 'SENTENCE'),
       (NOW(), NOW(), '아마추어는 버그 발견의 천재이다', 'SENTENCE'),
       (NOW(), NOW(), '된다고 말하기 전에 10초만 다시 생각해라', 'SENTENCE'),
       (NOW(), NOW(), 'Java는 동적 로딩 방식을 사용한다', 'SENTENCE'),
       (NOW(), NOW(), '레지스터: CPU 안에 있는 임시기억장치', 'SENTENCE'),
       (NOW(), NOW(), 'ALU: 논리 연산을 계산하는 디지털 회로', 'SENTENCE'),
       (NOW(), NOW(), 'RAM: 휘발성 기억 장치', 'SENTENCE'),
       (NOW(), NOW(), 'ROM: 고정 기억 장치', 'SENTENCE'),
       (NOW(), NOW(), 'TLB: 페이지 테이블을 캐싱한 저장장치', 'SENTENCE'),
       (NOW(), NOW(), 'TLB는 MMU 내부에 존재한다', 'SENTENCE'),
       (NOW(), NOW(), 'Redis는 싱글 스레드 기반으로 동작한다', 'SENTENCE'),
       (NOW(), NOW(), 'Memcached는 멀티스레드를 지원한다', 'SENTENCE'),
       (NOW(), NOW(), 'Redis는 키-값 기반의 NoSQL DB이다', 'SENTENCE'),
       (NOW(), NOW(), '아는 형님이요~', 'SENTENCE'),
       (NOW(), NOW(), '옥지얌 빵빵아', 'SENTENCE'),
       (NOW(), NOW(), '이거보세요오', 'SENTENCE'),
       (NOW(), NOW(), '뽀삐뽀삐뽀뽀삐뽀', 'SENTENCE'),
       (NOW(), NOW(), '너 T야?', 'SENTENCE'),
       (NOW(), NOW(), '하지만 빨랐죠', 'SENTENCE'),
       (NOW(), NOW(), '뉴진스의 하입보이요', 'SENTENCE'),
       (NOW(), NOW(), '중요한 건 꺾이지 않는 마음', 'SENTENCE'),
       (NOW(), NOW(), '폼 미쳤다', 'SENTENCE');
