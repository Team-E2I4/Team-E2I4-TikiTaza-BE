package com.pgms.api.socket.exception;
...
public class SocketGlobalExceptionHandler {
	...
	protected ResponseEntity<ErrorResponse> handleMethodArgumentNotValidException(MethodArgumentNotValidException ex) {
		...
		String errorMessage = GameRoomErrorCode.VALIDATION_FAILED.getMessage();

		List<FieldError> fieldErrors = bindingResult.getFieldErrors();
		ErrorResponse errorResponse = ErrorResponse.of(GameRoomErrorCode.VALIDATION_FAILED.getCode(), errorMessage);
