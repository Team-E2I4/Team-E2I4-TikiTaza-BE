...
public class GameSocketController {
	...
	public void updateGameInfo(
		...
		log.info(">>>>>> Game Real-Time Info : roomId = {}, accountId = {}", roomId, accountId);
		gameService.updateGameInfo(accountId, roomId, gameInfoUpdateRequest);
	}
	...
	public void updateWordGameInfo(
		...
		log.info(">>>>>> Word Game Real-Time Info : roomId = {}, accountId = {}", roomId, accountId);
		gameService.updateWordGameInfo(accountId, roomId, gameInfoUpdateRequest);
	}
